...
class AeroMarineVi(
    ...
    private val aeroMarineCallback: AeroMarineCallBack,
        ...
        super.setWebViewClient(object : WebViewClient() {
            ...
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                if (url?.contains("ninecasino") == true) {
                    AeroMarineApp.Companion.chickenInputMode = WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN
                    chickenWindow.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
                    fishingplannerEnableStableInputScroll()
                } else {
                    AeroMarineApp.Companion.chickenInputMode = WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE
    ...
    private fun fishingplannerHandleCreateWebWindowRequest(resultMsg: Message?) {
        ...
        if (resultMsg.obj != null && resultMsg.obj is WebViewTransport) {
            ...
            val windowWebView = AeroMarineVi(chickenContext, aeroMarineCallback, chickenWindow)
            transport.webView = windowWebView
            resultMsg.sendToTarget()
            aeroMarineCallback.chickenHandleCreateWebWindowRequest(windowWebView)
        }
    }
